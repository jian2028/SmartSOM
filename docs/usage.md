...
Detailed examples for SmartSOM configuration, simulation, training and validation.
Run the commands below from the repository root. For installation and a minimal
